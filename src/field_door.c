...
static const u8 sDoorAnimPalettes_Oldale[] = {10, 10, 8, 8, 8, 8, 8, 8};
static const u8 sDoorAnimPalettes_Mossdeep[] = {9, 9, 1, 1, 1, 1, 1, 1};
static const u8 sDoorAnimPalettes_PokemonLeague[] = {6, 6, 6, 6, 6, 6, 6, 6};
static const u8 sDoorAnimPalettes_Pacifidlog[] = {11, 11, 12, 12, 12, 12, 12, 12};
